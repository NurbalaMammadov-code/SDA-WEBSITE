...
import { listProjects, listPropertySectors } from '/assets/js/projectsApi.js';
...
async function init() {
  try { sectors = await listPropertySectors(); } catch { sectors = []; }
...
document.addEventListener('DOMContentLoaded', init);
  ...
  import { getProject } from '/assets/js/projectsApi.js';
import { getQuery } from '/assets/js/apiClient.js';
